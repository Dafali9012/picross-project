export default class PicrossMenu extends PIXI.Container {
    constructor(textures) {
        ...
        let solo = new PIXI.Sprite(this.textures["solo"]);
        let online = new PIXI.Sprite(this.textures["online"]);
        let build = new PIXI.Sprite(this.textures["build"]);
        ...
        solo.on("pointerup", ()=>{
            solo.texture = this.textures["solo"];
        });
        online.on("pointerup", ()=>{
            online.texture = this.textures["online"];
        });
        build.on("pointerup", ()=>{
